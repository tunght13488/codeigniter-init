...
$config['dev'] = (ENVIRONMENT === 'development');
...
// Modernizr
$config['groups']['modernizr'] = array(

	'js' => array(

		array('libs/modernizr-2.5.3-respond-1.1.0.min.js', 'libs/libs/modernizr-2.5.3-respond-1.1.0.min.js', FALSE, FALSE),
...
/* Location: ./application/config/carabiner.php */
